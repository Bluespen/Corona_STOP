...
namespace team_proj
{
    public partial class Form1 : Form
    {
        ...
        private void Find_item(string item)
        {
            ...
            if (item == "신촌역")
            {
                fm.Location = new System.Drawing.Point(parentPoint.X + 454, parentPoint.Y + 294);
                fm.label1.Text = item;
                fm.ShowDialog();
            }
            if (item == "신풍역")
        ...
        private void lbl_nowTime_Click(object sender, EventArgs e)
        {

        }

        private void scr_scale_Scroll(object sender, ScrollEventArgs e)
        {
